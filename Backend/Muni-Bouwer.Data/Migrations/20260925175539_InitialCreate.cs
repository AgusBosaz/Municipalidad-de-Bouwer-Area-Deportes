    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorActivities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InstructorActivities_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InstructorActivities_Users_InstructorId",
            ...
            migrationBuilder.CreateTable(
                name: "InstructorAttendances",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    InstructorActivityId = table.Column<int>(type: "int", nullable: false),
                    Date = table.Column<DateOnly>(type: "date", nullable: false),
                    IsPresent = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorAttendances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InstructorAttendances_InstructorActivities_InstructorActivityId",
                        column: x => x.InstructorActivityId,
                        principalTable: "InstructorActivities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enrollments_StudentActivities_StudentActivityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentAttendances_StudentActivities_StudentActivityId",
                        column: x => x.StudentActivityId,
                        principalTable: "StudentActivities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_StudentActivityId",
                table: "Enrollments",
                column: "StudentActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_InstructorActivities_ActivityId",
                table: "InstructorActivities",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_InstructorActivities_InstructorId",
                table: "InstructorActivities",
                column: "InstructorId");

            migrationBuilder.CreateIndex(
                name: "IX_InstructorAttendances_InstructorActivityId",
                table: "InstructorAttendances",
                column: "InstructorActivityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAttendances_StudentActivityId",
